...
class Collections extends \WP_Shopify\API {
	...
	*/
	public function get_all_collections($request) {
		...
		$param_limit 			= $this->DB_Settings_General->get_items_per_request();
		$smart_collections 	= $this->Shopify_API->sanitize_response($this->Shopify_API->get_smart_collections_per_page($param_limit, 1));
		$custom_collections 	= $this->Shopify_API->sanitize_response($this->Shopify_API->get_custom_collections_per_page($param_limit, 1));
