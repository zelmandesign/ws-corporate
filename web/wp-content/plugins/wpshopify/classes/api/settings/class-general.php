...
class General extends \WP_Shopify\API
{
   ...
   public function setting_to_slug($settings, $name, $default = false)
    ...
    public function update_settings($request)
    {
      ...
      //   $new_settings['related_products_images_sizing_crop'] = $this->setting_to_string($settings, 'wps_settings_related_products_images_sizing_crop', WP_SHOPIFY_DEFAULT_RELATED_PRODUCTS_IMAGES_SIZING_CROP);

      //   $new_settings['related_products_images_sizing_scale'] = $this->setting_to_string($settings, 'wps_settings_related_products_images_sizing_scale', WP_SHOPIFY_DEFAULT_RELATED_PRODUCTS_IMAGES_SIZING_SCALE);
