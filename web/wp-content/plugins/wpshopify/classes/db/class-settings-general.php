   ...
   public $default_account_page_set_password;
    ...
    public function __construct()
    {
        ...
        $this->default_is_syncing_posts = 1;
         ...
         $this->default_plugin_free_basename = 'wpshopify/wp-shopify.php';
    ...
    public function is_pro_tier()
    {
        ...
        if (Utils::array_not_empty($is_pro) && isset($is_pro[0]->is_pro)) {
            return Utils_Data::coerce($is_pro[0]->is_pro, 'bool');
    ...
    {
         $basename = $this->get_column_single('plugin_free_basename');

         if (Utils::array_not_empty($basename) && isset($basename[0]->plugin_free_basename)) {
            return Utils_Data::coerce($basename[0]->plugin_free_basename, 'string');

         } else {
            return 'wpshopify/wp-shopify.php'; // fallback
         }
